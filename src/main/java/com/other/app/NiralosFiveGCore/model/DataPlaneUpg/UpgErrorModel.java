...
@Entity
@Table(name="upg_error_data")
public class UpgErrorModel {
	...
	public UpgErrorModel(Long thread, Integer nat44_ed_out2in_slowpath_no_translation, Integer dpdk_input_no_error,
			...
			int mEC_tx_DPDK_tx_function_returned_an_error, int mEC_tx_Tx_packet_drops__dpdk_tx_failure, String nfType, String nfName) {
		super();
		this.thread = thread;
