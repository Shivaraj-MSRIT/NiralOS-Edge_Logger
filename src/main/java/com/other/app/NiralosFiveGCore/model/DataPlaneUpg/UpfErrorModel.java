...
@Entity
@Table(name="upf_error_data")
public class UpfErrorModel {
	...
	public UpfErrorModel(Integer tun_write_failure_upf, Integer invalid_eth_type_upf, Integer invalid_gtpu_version_upf,
