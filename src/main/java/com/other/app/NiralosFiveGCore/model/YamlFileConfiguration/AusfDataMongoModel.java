...
@Document
public class AusfDataMongoModel {
	...
	public AusfDataMongoModel(String id, SbiData sbi, AusfDataScpDto ausf, NrfSbiDto scp, String parameter, String max,
