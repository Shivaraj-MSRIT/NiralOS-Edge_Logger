...
public class CreateVmConfigDto {
		...
		private List<AddInterfaceDto> interfaces;
		
		public List<AddInterfaceDto> getInterfaces() {
			return interfaces;
		}

		public void setInterfaces(List<AddInterfaceDto> interfaces) {
